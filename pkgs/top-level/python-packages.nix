...
self: super: with self; {
 ...
 avidtools = callPackage ../development/python-modules/avidtools { };
  ...
  chumpy = callPackage ../development/python-modules/chumpy { };
  ...
  kwarray = callPackage ../development/python-modules/kwarray { };
  ...
  mmtrack = callPackage ../development/python-modules/mmtrack { };
  ...
  pycocoevalcap = callPackage ../development/python-modules/pycocoevalcap { };
