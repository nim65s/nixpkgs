...
self: super: with self; {
 ...
 avidtools = callPackage ../development/python-modules/avidtools { };
  ...
  gepetto-viewer-unwrapped = callPackage ../development/python-modules/gepetto-viewer-unwrapped { python3Packages =
    self; };
  ...
  hpp-baxter = pkgs.hpp-baxter.override { python3Packages = self; };

  hpp-bezier-com-traj = pkgs.hpp-bezier-com-traj.override { python3Packages = self; };
  ...
  ndcurves = toPythonModule (pkgs.ndcurves.override { python3Packages = self; });
  ...
  python-qt = pkgs.python-qt.override { python3 = self.python; };
