...
clangStdenv.mkDerivation (finalAttrs: {
  ...
  patches = [
    ...
    (fetchpatch {
      url = "https://github.com/google/filament/pull/8205/commits/816040b906e260acdf4835d1be0997e0b8793e31.patch";
      hash = "sha256-GtWZ1+A5dkytHg6TvzjDUqQbLgIOOUWlCo1BJV+XySI=";
    })
  ];
